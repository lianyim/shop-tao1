...
module.exports = {
  ...
  getGoodsByCid: function (cid, page, sort) {
    return httpRequest.get('/mi/load_goods_by_cid', {cid: cid, page: page, sort: sort})
  },
  ...
  shareImgList: function (page) {
	  return httpRequest.post('/share/load_live_shares', {page})
  },
  shareDetail: function (id) {
  	  return httpRequest.post('/share/shareDetail', {id})
  },
  like: function (id, flag) {
  	  return httpRequest.post('/share/like', {id, flag})
  },
  videoList: function (page) {
  	  return httpRequest.post('/video/loadVideos', {page})
  },
  commentList: function(id, flag) {
	  return httpRequest.post('/comment/loadComments', {id, flag})
  },
  addComment: function(id, content, flag, userId) {
	  return httpRequest.post('/comment/addComment', {id, content, flag, userId})
  }
}
